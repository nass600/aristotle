            ...
            <v-row>
                ...
                <v-col cols="11">
                    <v-row>
                        ...
                        <v-col cols="8">
                            <v-text-field v-model="element.publisher" label="publisher" hide-details/>
                        </v-col>
                        <v-col cols="4">
                            <v-text-field v-model="element.releaseDate" label="releaseDate" type="date" hide-details/>
                        </v-col>
                        <v-col cols="12">
                            <v-text-field v-model="element.url" label="url" hide-details/>
                        </v-col>
                        <v-col cols="12">
                            <v-textarea v-model="element.summary" label="summary" hide-details/>
                        </v-col>
                    </v-row>
                </v-col>
...
const props = defineProps({
    modelValue: {type: Array as PropType<ResumePublication[] | undefined>, required: true},
